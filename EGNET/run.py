...
if __name__ == '__main__':
    ...
    vgg_path = 'C:/Users/Deepali/data_acqu/EGNet/weights/vgg16_20M.pth'
    resnet_path = 'C:/Users/Deepali/data_acqu/EGNet/weights/resnet50_caffe.pth'
    ...
    parser.add_argument('--epoch', type=int, default=10) # 12, now x3
    ...
    # Testing settings
    parser.add_argument('--model', type=str, default='C:/Users/Deepali/Kosov/EGNet/model/epoch_resnet.pth')
