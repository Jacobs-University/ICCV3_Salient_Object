...
class ImageDataTrain(data.Dataset):
    def __init__(self):
        self.sal_root = 'C:/Users/Deepali/data_acqu/EGNet/DUTS-TR/'
        self.sal_source = 'C:/Users/Deepali/data_acqu/EGNet/DUTS-TR/train_pair_edge.lst'
...
class ImageDataTest(data.Dataset):
    def __init__(self, test_mode=1, sal_mode='p'):
         if test_mode == 1:
            if sal_mode == 'p':
                self.image_root = 'C:/Users/Deepali/data_acqu/EGNet/DUTS-TR/DUTS-TR-Image/'
                self.image_source = 'C:/Users/Deepali/data_acqu/EGNet/DUTS-TR/train_pair.lst'
                self.test_fold = 'C:/Users/Deepali/data_acqu/EGNet/DUTS-TR/Output/'
...
#pixels > 0.5 -> 1.Load label image as 1 x height x width integer array of label indices.
...
# pixels > 0 -> 1  Load label image as 1 x height x width integer array of label indices.
