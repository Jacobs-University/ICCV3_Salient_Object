...
if __name__ == "__main__":
    ...
    dataset_root = "D:/Data Acquisition/SCAS_Dataset/SCAS_Dataset/"
    weight_file_name = "sc_model_weights.pth"

    # Inference with model
    cfg = get_cfg()
    cfg.merge_from_file("C:/Users/Deepali/colab/models/sc_model.yaml")
    cfg.MODEL.WEIGHTS = "weights/" + weight_file_name

    cfg.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 8
    cfg.MODEL.RPN.PRE_NMS_TOPK_TEST = 8
    cfg.MODEL.RPN.POST_NMS_TOPK_TEST = 8
    cfg.MODEL.ROI_HEADS.NUM_CLASSES = 2
    predictor = DefaultPredictor(cfg)

    # Output file Location
    output_dir = "D:/Data Acquisition/saliency_prediction/"
